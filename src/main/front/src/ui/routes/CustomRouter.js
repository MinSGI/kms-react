...
const Map = lazy(() => import("ui/pages/map/Index"));

const News = lazy(() => import("ui/pages/news/Index"));
const NewsPage1 = lazy(() => import("ui/pages/news/News"));
const NewsPage2 = lazy(() => import("ui/pages/news/NaverNews"));
